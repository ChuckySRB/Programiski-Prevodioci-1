...
public class DesignatorStatementBrackets extends DesignatorStatement {

    private DesignatorOne DesignatorOne;
    private DesignatorList DesignatorList;
    private Designator Designator;

    public DesignatorStatementBrackets (DesignatorOne DesignatorOne, DesignatorList DesignatorList, Designator Designator) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementBrackets(\n");
